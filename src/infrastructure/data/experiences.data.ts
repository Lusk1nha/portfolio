...
export const EXPERIENCES: Experience[] = [
  {
    ...
    stack: ['Nest.js', 'FastAPI', 'React', 'TypeScript', 'PostgreSQL', 'RabbitMQ', 'DDD'],
  },
  {
    ...
    stack: ['React.js', 'Node.js', 'Python', 'Azure OpenAI', 'SPFx', 'Power Platform', 'Azure DevOps'],
  },
  {
    ...
    stack: ['React.js', 'SPFx', 'TypeScript', 'Azure OpenAI', 'Azure Cognitive Search'],
  },
  {
    ...
    stack: ['React.js', 'SPFx', 'Microsoft Graph API', 'JavaScript', 'RESTful Services'],
  },
]
