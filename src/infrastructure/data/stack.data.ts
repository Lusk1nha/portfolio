...
export const STACK_ITEMS: StackItem[] = [
  ...
  { id: 'cognitive-search', name: 'Azure Cognitive Search', group: 'ai', featured: false },

  // Arquitetura
  { id: 'ddd', name: 'DDD', group: 'architecture', featured: true },
  { id: 'microservices', name: 'Microsserviços', group: 'architecture', featured: true },
  { id: 'clean-arch', name: 'Clean Architecture', group: 'architecture', featured: true },
  ...
  { id: 'power-platform', name: 'Power Platform', group: 'tools', featured: false },
