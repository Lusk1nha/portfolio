              ...
              <div key={exp.id} className="group">
                ...
                <div className="mt-2 flex flex-wrap gap-1.5">
                  {exp.stack.map((tech) => (
                    <span
                      key={tech}
                      className="rounded-sm border border-(--accent)/20 bg-(--accent)/5 px-1.5 py-0.5 text-[10px] text-(--accent)"
                    >
                      {tech}
                    </span>
                  ))}
              ...
              <div key={group} className="flex gap-3">
                ...
                <div className="flex flex-wrap gap-1.5">
                  {groupedStack[group].map((tech) => (
                    <span
                      key={tech}
                      className="rounded-sm border border-(--border) bg-(--surface-2) px-1.5 py-0.5 text-[10px] text-(--fg)"
                    >
                      {tech}
                    </span>
                  ))}
